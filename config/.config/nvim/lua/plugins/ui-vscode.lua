...
-- File explorer, statusline, and visual improvements

return {
  -- Neo-tree file explorer (VSCode-like sidebar)
  {
  ...
  -- Enhanced statusline (VSCode-like status bar)
  {
  ...
  -- Highlight word under cursor (like VSCode)
  {
  ...
  -- Dashboard (VSCode-like welcome screen)
  {
